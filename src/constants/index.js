...
export const timelineItems = [
    // ── Early Work ──────────────────────────────────────────────────────────
    {
        ...
        description: 'A pixel-faithful replica of the Windows 11 desktop built with vanilla HTML, CSS, and JavaScript.',
        tags: [
        ...
        accent: '#9FD4FF',
        links: {
            live:   'https://itsSauraj.github.io/Windows11-Clone',
    ...
    },
    {
        ...
        date: 'Dec 2022',
        title: 'YouTube Clone',
        description: 'A YouTube clone that consumes a live API to render trending content, built entirely with React.',
        tags: [
        ...
        accent: '#F3C0E0',
        links: {
            live:   'https://youtube-clone-react-18.netlify.app/',
    ...
    },
    {
        ...
        description: "The portfolio you're on — dark, space-themed, built with React, Three.js (R3F), Framer Motion, and Vite.",
        tags: [
            { name: 'React',         color: 'blue-text-gradient' },
    ...
    // ── theBackOffice ────────────────────────────────────────────────────────
    {
        ...
        location: 'Remote',
        description: 'Developed backend APIs then contributed to the web platform frontend. Key project: a Multi-Tenant CA Management system.',
        points: [
            "Developed backend APIs, then contributed to the web platform's frontend.",
            'Worked across backend and frontend to ship features and improve functionality.',
            'Key project: a Multi-Tenant CA Management system.',
    ...
    },
    {
        ...
        sortDate: '2023-07',
        date: 'Jul 2023',
        title: 'Multi-Tenant CA System',
        description: 'Multi-tenant platform for Chartered Accountants to manage multiple clients, financial records, and workflows with backend APIs and a web interface.',
        tags: [
            { name: 'Django',     color: 'green-text-gradient' },
    ...
    // ── Yogya Capital ────────────────────────────────────────────────────────
    {
        ...
        company: 'Yogya Capital',
        location: 'Remote',
        description: 'Led project design, architecture, and deployment as Team Lead and Backend Developer. Built backend systems for finance and NSE-related workflows.',
        points: [
            'Led project design, architecture, and deployment as Team Lead and Backend Developer.',
            'Coordinated the team and managed the end-to-end development process.',
            'Built backend systems for finance and NSE-related workflows.',
    ...
    },
    {
        ...
        sortDate: '2023-12',
        date: 'Dec 2023',
        title: 'Finance & NSE Platform',
        description: 'Backend system for financial data workflows and NSE-related processes — system design, architecture, and deployment as team lead.',
        tags: [
            { name: 'Django',     color: 'green-text-gradient' },
            { name: 'Celery',     color: 'blue-text-gradient' },
            { name: 'Redis',      color: 'pink-text-gradient' },
    ...
    // ── La Net Team ──────────────────────────────────────────────────────────
    {
        ...
        location: 'Surat, India',
        description: 'Building AI-driven systems and microservices. Integrations with Shopify, QuickBooks, and Google Ads. AWS + Kubernetes deployments with Datadog monitoring.',
        points: [
            'Built integrations with Shopify, QuickBooks, and Google Ads using background workers.',
            'Led a team building microservices deployed via Docker on Railway with CI/CD.',
            'Building AI-driven systems with Django and FastAPI, integrating Anthropic, ChatGPT, and Gemini.',
            'Operated on AWS and Kubernetes with Datadog monitoring and GitHub Actions security checks.',
        ],
        tags: [
            ...
            { name: 'Datadog',    color: 'green-text-gradient' },
        ],
        accent: '#9FD4FF',
        links: {},
    },
    {
        ...
        sortDate: '2024-09',
        date: 'Sep 2024',
        title: 'MetricsNavigator',
        description: 'Data-integration platform connecting Shopify, QuickBooks, and Google Ads to sync business data through background workers, enabling centralized analytics.',
        tags: [
            { name: 'Django',     color: 'green-text-gradient' },
            { name: 'React',      color: 'blue-text-gradient' },
    ...
    },
    {
        ...
        date: 'Oct 2024',
        title: 'BCG-Internal',
        description: 'Internal enterprise tool integrating Anthropic, ChatGPT, and Gemini using Django and FastAPI to perform automated actions, AI-driven generation, and web-search workflows.',
        tags: [
            { name: 'FastAPI',    color: 'green-text-gradient' },
            { name: 'Celery',     color: 'blue-text-gradient' },
    ...
    },
    {
        ...
        date: 'Nov 2024',
        title: 'DevRob',
        description: 'Robotics simulation platform built on a microservices architecture with AI integrations to simulate robotic workflows and automate actions through intelligent systems.',
        tags: [
            { name: 'Node.js',  color: 'green-text-gradient' },
            { name: 'FastAPI',  color: 'pink-text-gradient' },
            { name: 'Next.js',  color: 'blue-text-gradient' },
            { name: 'Railway',  color: 'orange-text-gradient' },
    ...
    // ── Personal 2025 ────────────────────────────────────────────────────────
    {
        ...
        description: 'Full-stack platform for managing trainees, courses, assessments, and communication — REST API (Python/FastAPI) + TypeScript frontend.',
        tags: [
            { name: 'FastAPI',    color: 'green-text-gradient' },
        ...
        accent: '#A9E8D0',
        links: {
            source: 'https://github.com/itsSauraj/core',
        },
    },
    // ── 2026 ─────────────────────────────────────────────────────────────────
    {
        ...
        description: 'Web-based file manager for Amazon S3 and S3-compatible storage (e.g. Cloudflare R2) with a GNOME Files–inspired interface.',
        tags: [
            { name: 'Next.js',    color: 'blue-text-gradient' },
            { name: 'TypeScript', color: 'pink-text-gradient' },
            { name: 'Tailwind',   color: 'orange-text-gradient' },
            { name: 'AWS SDK',    color: 'green-text-gradient' },
        ],
        accent: '#9FD4FF',
        links: {
